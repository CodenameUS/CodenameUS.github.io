...
&nbsp;
<u>InventoryUI</u> 클래스는 인벤토리의 틀이고, 그 안에 개별 <u>ItemSlotUI</u>들이 존재합니다.

인벤토리에서 필요한 기능들은 <u>Inventory</u> 클래스가 담당합니다. 

따라서 <u>ItemSlotUI</u>에서 필요한 <u>Item</u>의 공유는 <u>InventoryUI</u>, <u>Inventory</u>에 의해 간접적으로 이루어지도록 하였습니다.
