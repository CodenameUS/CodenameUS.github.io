...
<u>InitializeScene</u>에는 "게임 전반에 걸쳐 유지되어야하는 오브젝트들"이 존재합니다.
...
* **Inventory** : 인벤토리내의 아이템 데이터를 관리하고, 인벤토리의 실질적인 동작을 처리합니다.
    ...
    - [Inventory Code](https://github.com/CodenameUS/Sample-Project/blob/main/Assets/Scripts/UI/Inventory/Inventory.cs)
* **InventoryUI** : 인벤토리내의 마우스 이벤트와 모든 아이템 슬롯을 관리합니다.
    ...
    - 마우스 클릭, 드래그 앤 드롭을 구현하여 인벤토리내 UI와 상호작용할 수 있도록 했습니다.
        ...
        - [UIRaycaster Code](https://github.com/CodenameUS/Sample-Project/blob/main/Assets/Scripts/UI/UIRaycaster.cs)
    - 인벤토리의 아이템 슬롯 정보들을 리스트로 관리합니다.
    - [InventoryUI Code](https://github.com/CodenameUS/Sample-Project/blob/main/Assets/Scripts/UI/Inventory/InventoryUI.cs)
* **ItemSlotUI** : 각 아이템 슬롯의 데이터를 관리하고, 슬롯에서 발생하는 기능들을 구현합니다.
    ...
    - [ItemSlotUI Code](https://github.com/CodenameUS/Sample-Project/blob/main/Assets/Scripts/UI/Inventory/ItemSlotUI.cs)
...
[무기관련 Code](https://github.com/CodenameUS/Sample-Project/tree/main/Assets/Scripts/Player/Player%20Attack/Weapons)
...
2. 로드된 데이터를가지고 **WeaponManager**의 **SetWeapon()** 호출요청
    - 만약 무기를 장착중이지 않은 상태라면 기본값(Punch) 전달

3. **SetWeapon()** 에서 플레이어의 무기를 세팅
    - 무기 프리팹 생성
    - 현재 무기정보 갱신 
...
[UIManager Code](https://github.com/CodenameUS/Sample-Project/blob/main/Assets/Scripts/Managers/UIManager.cs)
...
[MatchManager Code](https://github.com/CodenameUS/Sample-Project/blob/main/Assets/Scripts/Managers/MatchManager.cs)
...
물론 혼자 개발하면서 벽에 부딪힌 순간도 많았고, 디버깅에 며칠씩 매달리기도 했습니다.
